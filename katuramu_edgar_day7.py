...
with open('edgar.txt', 'w') as file:
    file.write('I am Katuramu Edgar and I love python.\n')
    file .write('I use python for automation')
    
# Reading from a text file
with open('edgar.txt', 'r') as file:
    content = file.read()
    print(content)
...
with open ('edgar.csv', 'w', newline='') as csv_file:
    writer = csv.writer(csv_file)
    writer.writerow(['name', 'position', 'course'])
    writer.writerow(['Katuramu Edgar', 'Student', 'BSSE'])
    
# Read from a CSV file
with open('edgar.csv', 'r') as csv_file:
